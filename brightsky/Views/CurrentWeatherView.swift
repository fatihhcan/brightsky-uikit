    ...
    private func layout(for sectionIndex: Int) -> NSCollectionLayoutSection {
        ...
        case .current:
            ...
            let group = NSCollectionLayoutGroup.vertical(
                layoutSize: .init(widthDimension: .fractionalWidth(1.0), heightDimension: .fractionalHeight(0.75)),
                subitems: [item])
...
extension CurrentWeatherView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        case .daily(viewModel: let viewModels):
            return viewModels.count
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .daily(let viewModels):
            ...
            return cell
        case .hourly(viewModel: let viewModels):
